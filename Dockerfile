...
RUN echo 'alias train_lyft_head_per_dataset="python train.py --cfg_file cfgs/da-waymo-lyft-pandaset-nuscenes-to-kitti_models/domain_attention_head_per_dataset/second_old_anchor_lyft_car_ped.yaml --batch_size 16 --epochs 5"' >> /root/.bashrc
