...
RUN echo 'alias self_train_single_no_pretrain="python train.py --cfg_file cfgs/da-waymo-lyft-pandaset-to-kitti_models/domain_attention_head_per_dataset/second_old_anchor_waymo_lyft_pandaset_to_kitti_st3d_car_basebev.yaml --pretrained_model_teacher /storage/wandb/run-20230821_222115-469by94p/files/checkpoint_epoch_5.pth"' >> /root/.bashrc
