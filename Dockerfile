...
RUN echo 'alias test_wlpk_head_per_dataset_target="python test.py --cfg_file cfgs/da-waymo-lyft-pandaset-kitti-to-nuscenes_models/domain_attention_head_per_dataset/second_old_anchor_waymo_lyft_pandaset_kitti_car_ped_target_nuscenes.yaml --ckpt /storage/wandb/run-20240211_000530-hng69v7k/files/checkpoint_epoch_5.pth"' >> /root/.bashrc
RUN echo 'alias test_wlpn_basebev_head_per_dataset_target="python test.py --cfg_file cfgs/da-waymo-lyft-pandaset-nuscenes-to-kitti_models/domain_attention_head_per_dataset/second_old_anchor_basebev_waymo_lyft_pandaset_nuscenes_car_ped_target_kitti.yaml --ckpt /storage/wandb/run-20240311_160001-ki04bs16/files/checkpoint_epoch_5.pth"' >> /root/.bashrc
RUN echo 'alias test_wlpk_basebev_head_per_dataset_target="python test.py --cfg_file cfgs/da-waymo-lyft-pandaset-kitti-to-nuscenes_models/domain_attention_head_per_dataset/second_old_anchor_basebev_waymo_lyft_pandaset_kitti_car_ped_target_nuscenes.yaml --ckpt /storage/wandb/run-20240311_160015-x22b4i0s/files/checkpoint_epoch_5.pth"' >> /root/.bashrc
...
RUN python3 -m pip install wandb --upgrade
