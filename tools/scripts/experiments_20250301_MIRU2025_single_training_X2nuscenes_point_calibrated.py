...
dict_cfg_pandaset2nuscenes = {
    "name": f"train_pandaset2nuscenes_{common_suffix}",
    "script": 'train.py',
...
dict_cfgs = [dict_cfg_lyft2nuscenes, dict_cfg_pandaset2nuscenes, dict_cfg_waymo2nuscenes, dict_cfg_kitti2nuscenes]
