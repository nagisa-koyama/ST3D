...
common_prefix = "post_MIRU2025_st3d_dann_source_target"
common_suffix = "point_label_calibrated_hist_517oe15r_batch12"
common_args = "--batch_size 12"
# common_platform = "--use_subset"
common_platform = ""

dict_cfg_lyft2kitti = {
    "name": f"{common_prefix}_lyft2kitti_io1npo_{common_suffix}",
    # "name": "",
    "script": 'train.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2kitti_dann_source_target_car_ped_point_label_calibrated.yaml",
...
dict_cfg_lyft2nuscenes = {
    ...
    "script": 'train.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2nuscenes_dann_source_target_car_ped_point_label_calibrated.yaml",
