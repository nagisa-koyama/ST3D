...
common_prefix = "post_MIRU2025_st3d_target_student_xyzi"
...
dict_cfg_lyft2kitti = {
    ...
    # "name": "",
    "script": 'train.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2kitti_target_car_ped_point_label_calibrated_xyzi.yaml",
...
dict_cfg_lyft2nuscenes = {
    ...
    "script": 'train.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2nuscenes_target_car_ped_point_label_calibrated_xyzi.yaml",
