...
dict_cfg_lyft2kitti = {
    ...
    "script": 'train.py',
    "cfg_file": "cfgs/da-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2kitti_target_car_ped_point_label_calibrated.yaml",
...
dict_cfg_lyft2nuscenes = {
    ...
    "script": 'train.py',
    "cfg_file": "cfgs/da-MIRU2025/second_old_anchor_st3d_basebev_multi_lyft2nuscenes_target_car_ped_point_label_calibrated.yaml",
