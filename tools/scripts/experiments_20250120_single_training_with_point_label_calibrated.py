...
dict_cfg_no_shift_num_point = {
    "name": f"{common_prefix}_no_shift_coor_num_point_calibrated_{common_suffix}",
    "script": 'train.py',
...
dict_cfg_no_shift_label = {
    "name": f"{common_prefix}_no_shift_coor_label_calibrated_{common_suffix}",
    "script": 'train.py',
...
dict_cfg_shift_point_label = {
    "name": f"{common_prefix}_shift_coor_point_label_calibrated_v3_{common_suffix}",
    "script": 'train.py',
...
dict_cfg_shift_point_label_v5 = {
    "name": f"{common_prefix}_shift_coor_point_label_calibrated_v5_{common_suffix}",
    "script": 'train.py',
