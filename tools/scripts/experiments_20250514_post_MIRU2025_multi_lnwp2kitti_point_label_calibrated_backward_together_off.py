...
dict_cfg_lnwp2kitti_default = {
    "name": f"{common_prefix}_lnwp2kitti_{common_suffix}",
    # "name": "",
    "script": 'train.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_basebev_multi_lnwp2kitti_car_ped_point_label_calibrated_backward_together_off.yaml",
    "teacher_ckpt": "",
    "pretrained_ckpt": "",
    "ckpt_dir": "",
    "args": common_args,
...
dict_cfg_lnwp2kitti_test = {
    "name": f"test_{common_prefix}_lnwp2kitti_{common_suffix}_rgusqmzc",
    "name": "",
    "script": 'test.py',
    "cfg_file": "cfgs/da-post-MIRU2025/second_old_anchor_basebev_multi_lnwp2kitti_car_ped_point_label_calibrated_backward_together_off.yaml",
    "teacher_ckpt": "",
    "pretrained_ckpt": "",
    "ckpt_dir": "/storage/wandb/run-20250513_170334-rgusqmzc/files/ckpt",
    "args": common_args,
    "platform": common_platform,
}
